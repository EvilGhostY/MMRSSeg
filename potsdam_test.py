...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default=r'MMRSSeg/config/potsdam/csfaformer.py', help="Path to config")
    arg("-o", "--output_path", type=Path, default=r'MMRSSeg/fig_results/potsdam/csfaformer', help="Path where to save resulting masks.")
