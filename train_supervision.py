...
class Supervision_Train(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.loss(prediction, mask, dsm)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        loss_val = self.loss(prediction, mask, dsm)
 ...
 #           log_dict[f"val_IoU_{class_name}"] = IoU_per_class[class_idx]
...
def main():
    ...
    trainer = pl.Trainer(devices=config.gpus, max_epochs=config.max_epoch, accelerator='gpu',
                         ...
                         callbacks=[checkpoint_callback], strategy=None,
                          logger=logger)
